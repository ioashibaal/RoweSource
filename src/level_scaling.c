...
const u8 Hard_Mode_Boss_Pokemon_Min_Level[] 	     = {13,19,25,31,38,45,51,62,70,100,100};	//Levels for Gym Leaders
const u8 Hard_Mode_Trainer_Pokemon_Min_Level[]       =  {7,13,19,25,32,38,44,50,57,100,100};	//Levels for Trainer Pokemon
const u8 Hard_Mode_Min_Wild_Pokemon_Level[]          =  {5,11,16,21,26,32,38,45,52,100,100};	//Levels for Wild Pokemon
